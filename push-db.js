...
if (PARAMS.length < 2 || CONFIGURATION['environments-list'].indexOf(PARAMS[0]) == -1) {
  console.log('You must pass ENV and date to recovery. You cand pass a specific collection to recovery');
  process.exit();
}
